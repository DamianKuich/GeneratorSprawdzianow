    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(3, 'Krótka odpowiedź'), (0, 'Nieznany'), (2, 'Zamknięte'), (1, 'Otwarte')])),
                ('level', models.IntegerField(choices=[(1, 'Podstawowy'), (0, 'Nieznany'), (2, 'Rozszerzony')])),
