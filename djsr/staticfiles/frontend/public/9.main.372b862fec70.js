  ...
  _createClass(UserExams, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_10__["default"], {
        ...
        validationSchema: yup__WEBPACK_IMPORTED_MODULE_6__["object"]().shape((_Yup$object$shape = {
          examName: yup__WEBPACK_IMPORTED_MODULE_6__["string"]().min(2, "Nazwa za krotka").max(50, "Nazwa za dluga").required("Pole wymagane")
        }, _defineProperty(_Yup$object$shape, "examName", yup__WEBPACK_IMPORTED_MODULE_6__["string"]().min(1, "Nazwa za krotka").required("Pole wymagane")), _defineProperty(_Yup$object$shape, "examName", yup__WEBPACK_IMPORTED_MODULE_6__["string"]().min(1, "Nazwa za krotka").required("Pole wymagane")), _defineProperty(_Yup$object$shape, "examName", yup__WEBPACK_IMPORTED_MODULE_6__["string"]().min(1, "Nazwa za krotka").required("Pole wymagane")), _Yup$object$shape)),
        onSubmit: function onSubmit(values, helpers) {
          setTimeout(function () {
            helpers.setSubmitting(true);
            _axiosAPI__WEBPACK_IMPORTED_MODULE_3__["default"].post("/user/maketest/", {
