...
var MaterialUiManageAccount = function MaterialUiManageAccount(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    validationSchema: yup__WEBPACK_IMPORTED_MODULE_23__["object"]().shape({
      email: yup__WEBPACK_IMPORTED_MODULE_23__["string"]().min(2, "Too Short!").max(50, "Too Long!").required(FRS)
    }),
    ...
    }, "Zmie\u0144 dane"), isSubmitting && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(LoadingScreenB, null)));
    ...
    validationSchema: yup__WEBPACK_IMPORTED_MODULE_23__["object"]().shape({
      name: yup__WEBPACK_IMPORTED_MODULE_23__["string"]().min(2, "Too Short!").max(50, "Too Long!").required(FRS)
    }),
    onSubmit: function onSubmit(values, helpers) {
      setTimeout(function () {
        helpers.setSubmitting(true);
    ...
    validationSchema: yup__WEBPACK_IMPORTED_MODULE_23__["object"]().shape({
      password: yup__WEBPACK_IMPORTED_MODULE_23__["string"]().min(8, "Too Short!").max(50, "Too Long!").required("Pole wymagane").oneOf([yup__WEBPACK_IMPORTED_MODULE_23__["ref"]("passwordConfirm")], "Hasła są różne"),
      oldPassword: yup__WEBPACK_IMPORTED_MODULE_23__["string"]().min(8, "Too Short!").max(50, "Too Long!").required("Pole wymagane"),
