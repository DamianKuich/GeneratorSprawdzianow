...
/* harmony import */ var _img_genesprDark_png__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./img/genesprDark.png */ "./djsr/frontend/src/components/img/genesprDark.png");
/* harmony import */ var yup__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! yup */ "./node_modules/yup/es/index.js");
/* harmony import */ var _axiosAPI__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./axiosAPI */ "./djsr/frontend/src/components/axiosAPI.js");
...
/* harmony import */ var _MaterialFormikField__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./MaterialFormikField */ "./djsr/frontend/src/components/MaterialFormikField.js");
/* harmony import */ var _material_ui_lab_ToggleButton__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @material-ui/lab/ToggleButton */ "./node_modules/@material-ui/lab/esm/ToggleButton/index.js");
/* harmony import */ var _material_ui_lab_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @material-ui/lab/ToggleButtonGroup */ "./node_modules/@material-ui/lab/esm/ToggleButtonGroup/index.js");
var _this = undefined;
...
var MaterialUiManageAccount = function MaterialUiManageAccount(props) {
  ...
  var bgStyles = {
    paperContainer: {
      backgroundImage: "url(".concat(_img_genesprDark_png__WEBPACK_IMPORTED_MODULE_21__["default"], ")"),
      minHeight: 1000
    },
    examCardContainer: {
      width: 700,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_7__["default"], {
  ...
  }, editView == "email" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_24__["Formik"], {
    initialValues: {
      name: "",
      email: "",
      password: "",
    ...
    validationSchema: yup__WEBPACK_IMPORTED_MODULE_22__["object"]().shape({
      name: yup__WEBPACK_IMPORTED_MODULE_22__["string"]().min(2, "Too Short!").max(50, "Too Long!").required(FRS),
      password: yup__WEBPACK_IMPORTED_MODULE_22__["string"]().min(8, "Too Short!").max(50, "Too Long!").required(FRS),
      passwordConfirm: yup__WEBPACK_IMPORTED_MODULE_22__["string"]().oneOf([yup__WEBPACK_IMPORTED_MODULE_22__["ref"]("password")], "Hasła są różne").required(FRS),
      email: yup__WEBPACK_IMPORTED_MODULE_22__["string"]().email("Nieprawidłowy adres e-mail").required(FRS)
    }),
    onSubmit: function onSubmit(values, helpers) {
      setTimeout(function () {
        helpers.setSubmitting(true);
        _axiosAPI__WEBPACK_IMPORTED_MODULE_23__["axiosInstanceNoAuth"].put("/user/update/", {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
      ...
      container: true,
      justify: "center"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_lab_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_27__["default"], {
    ...
    }, "Zmie\u0144 has\u0142o"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_24__["Field"], {
      component: _MaterialFormikField__WEBPACK_IMPORTED_MODULE_25__["default"],
      name: "email",
      formControlProps: {
        fullWidth: true
      },
  ...
  }) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null), editView == "name" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_24__["Formik"], {
    initialValues: {
      name: ""
    },
    validationSchema: yup__WEBPACK_IMPORTED_MODULE_22__["object"]().shape({
    ...
    onSubmit: function onSubmit(values, helpers) {
      setTimeout(function () {
        helpers.setSubmitting(true);
        _axiosAPI__WEBPACK_IMPORTED_MODULE_23__["default"].put("/user/update/", {
          username: values.name
        }).then(function (response) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
      ...
      color: "primary",
      className: classes.cardHeader
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", null, "Edytuj dane")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_components_Card_CardBody_js__WEBPACK_IMPORTED_MODULE_15__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_lab_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_27__["default"], {
      orientation: "vertical",
      color: "primary",
      "aria-label": "vertical contained primary button group",
      variant: "text"
  ...
  }) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null), editView == "password" ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_24__["Formik"], {
    initialValues: {
      password: "",
      passwordConfirm: "",
      oldPassword: ""
    ...
    validationSchema: yup__WEBPACK_IMPORTED_MODULE_22__["object"]().shape({
      password: yup__WEBPACK_IMPORTED_MODULE_22__["string"]().min(8, "Too Short!").max(50, "Too Long!").required("Pole wymagane").oneOf([yup__WEBPACK_IMPORTED_MODULE_22__["ref"]("passwordConfirm")], "Hasła są różne"),
      oldPassword: yup__WEBPACK_IMPORTED_MODULE_22__["string"]().min(8, "Too Short!").max(50, "Too Long!").required("Pole wymagane"),
      passwordConfirm: yup__WEBPACK_IMPORTED_MODULE_22__["string"]().oneOf([yup__WEBPACK_IMPORTED_MODULE_22__["ref"]("password")], "Hasła są różne").required("Pole wymagane")
    }),
    onSubmit: function onSubmit(values, helpers) {
      setTimeout(function () {
        helpers.setSubmitting(true);
    ...
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_24__["Field"], {
      component: _MaterialFormikField__WEBPACK_IMPORTED_MODULE_25__["default"],
